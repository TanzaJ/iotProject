...
window.onload = function () {
	var tempKnob = pureknob.createKnob(250, 250);

	// Set properties.
	tempKnob.setProperty('angleStart', -0.75 * Math.PI);
	tempKnob.setProperty('angleEnd', 0.75 * Math.PI);
	tempKnob.setProperty('colorFG', '#ececec');
	tempKnob.setProperty('colorBG', '#222222');
	tempKnob.setProperty('trackWidth', 0.4);
	tempKnob.setProperty('valMin', 0);
	tempKnob.setProperty('valMax', 50);
	tempKnob.setProperty('readonly', true);
	tempKnob.setProperty('textScale', 0.8);

	// Set initial value.
	tempKnob.setValue(29);

	var node = tempKnob.node();
	var elem = document.getElementById('thermometerGauge');
	elem.appendChild(node);

	var humidityKnob = pureknob.createKnob(250, 250);

	// Set properties.
	humidityKnob.setProperty('angleStart', -0.75 * Math.PI);
	humidityKnob.setProperty('angleEnd', 0.75 * Math.PI);
	humidityKnob.setProperty('colorFG', '#76c8e3');
	humidityKnob.setProperty('colorBG', '#222222');
	humidityKnob.setProperty('trackWidth', 0.4);
	humidityKnob.setProperty('valMin', 0);
	humidityKnob.setProperty('valMax', 100);
	humidityKnob.setProperty('readonly', true);
	humidityKnob.setProperty('textScale', 0.8);

	// Set initial value.
	humidityKnob.setValue(75);

	var node = humidityKnob.node();
	var elem = document.getElementById('humidityGauge');
	elem.appendChild(node);
